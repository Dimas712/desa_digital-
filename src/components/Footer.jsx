      ...
      <div className="mx-auto w-full max-w-screen-xl px-[32px] py-6">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 max-w-[300px]">
            ...
            <a>
              Desa Digital merupakan website yang membantu masyarakat 
              untuk mengurus administrasi di kantor desa tanpa harus
          ...
          <div className="grid grid-cols-2 gap-1 sm:gap-1 sm:grid-cols-3">
            ...
            <div className="max-w-[220px] mt-6 md:mt-0">
              ...
              <ul className="text-gray-500 font-medium">
                ...
                <li className="mb-4">
                  <a className="hover:underline">
                    087737968218 ( Quick Response )
                  </a>
                </li>
                <li>
                  <a className="hover:underline">desadigital@yahoo.com</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center">
            © 2024 <a className="hover:underline">govTechnology™</a>. All Rights
            Reserved.
          </span>
